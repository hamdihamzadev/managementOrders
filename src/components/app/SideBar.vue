<template>
  <div class="aside fixed-top">
    <div class="nav-aside">
      ...
      <div class="links ">
        <ul>
          <router-link to="/" tag="li"><a href="" class="dashbord"><i class='bx bxs-pie-chart-alt'></i>Dashbord</a>
          </router-link>
          ...
          <li>
            ...
            <b-collapse id="collapse-3" class="mt-3 mb-3">
              ...
              <router-link to="/Orders/Deliverd" tag="li"><a href="" class="linkdrop">Deliverd</a></router-link>
          ...
          <router-link to="/Products" tag="li"><a href=""><i class='bx bxs-shopping-bag-alt'></i>Products</a>
          </router-link>
          <router-link to="/Stock" tag="li"><a href=""><i class='bx bxs-doughnut-chart'></i>Stock</a></router-link>
          <li>

            <a href="#" @click="chnageicon" v-b-toggle.collapse-Statistics>
              <i class='bx bxs-bar-chart-alt-2'></i>Statistics<i class='bx bxs-chevron-up' id="icArrow-statist"></i>
            </a>

            <b-collapse id="collapse-Statistics" class="mt-3 mb-3">
              <router-link to="/Statistics/Top" tag="li"><a href="" class="linkdrop">Top</a></router-link>
              <router-link to="/Statistics/Worst" tag="li"><a href="" class="linkdrop">Worst</a></router-link>
            </b-collapse>
          </li>
          <router-link to="/" tag="li"><a href=""><i class='bx bxs-dollar-circle'></i>Profitability</a></router-link>
          <router-link to="/LoginUser" tag="li"><a href=""><i class='bx bxs-message-rounded-dots'></i>LoginUser</a>
          </router-link>
          <router-link to="/Signup" tag="li"><a href=""><i class='bx bxs-message-rounded-dots'></i>Signup</a>
          </router-link>
          <router-link to="/Login" tag="li"><a href=""><i class='bx bxs-message-rounded-dots'></i>Login</a>
          </router-link>
        </ul>
      </div>
    </div>
    ...
    mounted() {
      ...
      allLinks.forEach(link => {
        link.addEventListener('click', () => {
          // remove active in all element
          allLinks.forEach(a => {
            a.classList.remove('active')
          })
          // add active in element clicked
